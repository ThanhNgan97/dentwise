                ...
                <div className="flex items-center gap-8">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        >
                            ...
                            <span className="hidden md:inline">{dict.dashboard.navbar.dashboard}</span>
                        </Link>
                        ...
                        >
                            ...
                            <span className="hidden md:inline">{dict.dashboard.navbar.appointments}</span>
                        </Link>
                        ...
                        >
                            ...
                            <span className="hidden md:inline">{dict.dashboard.navbar.voice}</span>
                        </Link>
                        <Link
                            href="/pro"
                        ...
                        >
                            ...
                            <span className="hidden md:inline">{dict.dashboard.navbar.pro}</span>
                        </Link>
                    </div>
                </div>
