            ...
            <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30">
                ...
                <CardContent className="relative p-8">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <h3 className="text-2xl font-bold mb-2">{dict.dashboard.mainActions.aiVoice.title}</h3>
                            <p className="text-muted-foreground">{dict.dashboard.mainActions.aiVoice.subtitle}</p>
                        </div>
                    </div>

                    <div className="space-y-4">
                        {dict.dashboard.mainActions.aiVoice.features.map((feature, i) => (
                    ...
                    >
                        ...
                        {dict.dashboard.mainActions.aiVoice.cta}
                    </Link>
                </CardContent>
            </Card>
            ...
            <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30">
                ...
                <CardContent className="relative p-8">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <h3 className="text-2xl font-bold mb-2">{dict.dashboard.mainActions.bookAppointment.title}</h3>
                            <p className="text-muted-foreground">{dict.dashboard.mainActions.bookAppointment.subtitle}</p>
                        </div>
                    </div>

                    <div className="space-y-4">
                        {dict.dashboard.mainActions.bookAppointment.features.map((feature, i) => (
                            <div key={i} className="flex items-center gap-3">
                                <div className="w-2 h-2 bg-primary rounded-full"></div>
                                <span className="text-sm">{feature}</span>
                            </div>
                    ...
                    <Link href="/appointments">
                        ...
                        >
                            ...
                            {dict.dashboard.mainActions.bookAppointment.cta}
                        </Button>
                    </Link>
                </CardContent>
            </Card>
