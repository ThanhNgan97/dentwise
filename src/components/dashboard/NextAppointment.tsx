        ...
        <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-background">
            <CardHeader>
                <CardTitle className="flex items-center gap-2">
                    ...
                    {dict.dashboard.nextAppointment.title}
                </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/10 rounded-full border border-primary/20">
                        ...
                        <span className="text-sm font-medium text-primary">
                            {isToday ? dict.dashboard.nextAppointment.today : dict.dashboard.nextAppointment.upcoming}
                        </span>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                {isToday ? dict.dashboard.nextAppointment.today : format(appointmentDate, "EEEE")}
                            </p>
                        </div>
                    </div>
                ...
                {upcomingAppointments.length > 1 && (
                    <p className="text-xs text-center text-muted-foreground">
                        +{upcomingAppointments.length - 1} {upcomingAppointments.length > 2 ? dict.dashboard.nextAppointment.moreAppointmentsPlural : dict.dashboard.nextAppointment.moreAppointments}
                    </p>
                )}
            </CardContent>
        </Card>
